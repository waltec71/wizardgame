init python:
    ...
    # Configuration
    API_KEY = "AIzaSyAlSlu_kXZxcalUHL_eYE26k1uGanB9dsU"  
    ...
    def generate_story(context, player_choice):
        try:
            ...
            Generate the next part of the story (1-2 paragraphs) and provide 3 choices for the player.
            ...
            return f"The ancient tome's pages blur before your eyes. (Error: {str(e)})", ["Continue cautiously", "Try a different approach", "Rest and recover"]
